...
type LimelightNavProps = {
  ...
  /** Strip the nav's own bg/border/rounded so a parent can own the container styles. */
  bare?: boolean;
};
...
export const LimelightNav = ({
  ...
  return (
    <nav className={bare ? `relative flex items-center h-full ${className ?? ""}` : `relative inline-flex items-center h-16 rounded-lg bg-card text-foreground border px-2 ${className ?? ""}`}>
